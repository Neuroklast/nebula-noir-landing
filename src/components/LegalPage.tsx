...
export function LegalPage({ section, open, onOpenChange }: LegalPageProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] md:w-[calc(100vw-4rem)] md:max-w-[calc(100vw-4rem)] lg:w-[calc(100vw-6rem)] lg:max-w-[calc(100vw-6rem)] max-h-[90vh] p-0 bg-background border-2 border-foreground/30 flex flex-col overflow-hidden">
