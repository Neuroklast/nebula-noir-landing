...
export function LegalPage({ section, open, onOpenChange }: LegalPageProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 bg-background border-2 border-foreground/30 metallic-border">
        <DialogHeader className="p-8 pb-4 border-b border-foreground/20">
        ...
        <ScrollArea className="h-[calc(90vh-120px)] px-8 pb-8">
          <div 
